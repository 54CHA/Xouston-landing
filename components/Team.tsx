          ...
          >
            <div className="lg:sticky lg:top-24">
              ...
              <p className="text-lg sm:text-xl text-indigo-200 mb-8 sm:mb-12">
                Наша команда объединяет профессионалов различных направлений: опытных frontend, backend и fullstack разработчиков,
                UI/UX дизайнеров, специалистов по мобильной разработке, DevOps инженеров и digital-маркетологов <br />
